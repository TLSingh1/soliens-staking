<template>
  <div class="flex text-center mb-10 m-3">
    <div class="is-dark flex-1">
      <select class="bg-deep-purple-accent-400 shadow-2xl w-11/12 h-10 p-1 m-4 mb-0 rounded-md text-white text-center font-bold hover:bg-deep-purple-accent-700" required id="cluster" v-model="chosenCluster">
    ...
    <div class="is-dark flex-1">
      <select class="bg-deep-purple-accent-400 shadow-2xl w-11/12 h-10 p-1 m-4 mb-0 rounded-md text-white text-center font-bold hover:bg-deep-purple-accent-700" required id="wallet" v-model="chosenWallet">
